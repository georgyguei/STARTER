// Importing React types for usage in type definitions
...
type UIComponentProps = {
  /**
   * Specifies the number of lines to display for text truncate.
   */
  noOfLines?: string;
};
...
> = ComponentWithAs<T, Assign<UIComponentProps, P>>;
